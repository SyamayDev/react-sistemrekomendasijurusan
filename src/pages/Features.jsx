  ...
  return (
    ...
    >
      <div className="listar-feature-item listar-feature-has-link">
        ...
        <a href="https://codepen.io/uiswarup/full/yLzypyY" target="_blank" rel="noopener noreferrer"></a>
  ...
  const featuresData = [
{
  ...
  description:
    'Jawab beberapa pertanyaan singkat untuk mengetahui minat dan potensi akademik Anda.',
...
},
{
  ...
  description:
    'Sistem menganalisis jawaban Anda secara objektif menggunakan pendekatan berbasis data.',
...
},
{
  ...
  description:
    'Dapatkan rekomendasi jurusan yang cocok untuk Anda, dengan persentase kemungkinan tinggi.',
